...
---------------------------
The parts crib in humber college has always been widely used by all students in the school of technology and we have always felt like it could be improved to be more efficient and to give students more information about the parts they were going to use in their labs. We also feel like it could use more control over specific parts that are out and have not been returned yet, or could have been damaged. With this in mind, we decided to make our project based on the parts crib and on how we could improve it.

The project is called the parts crib flow, since the main idea is to improve the flow of parts coming in and out of the crib, and also of the prototype lab. The idea is to create a database with information about all parts, such as specifications, warnings and whatever else may apply to the specific part. A form of database using SQL, as informed by our hardware professor, was already started but vaguely therefore we could just continue where it was left off and update it with all parts. We would also create an app to display this information and it would also allow the user to request parts remotely. The request when made through the app is going straight to the cribs operator’s computer and from there he can prepare the equipment and send a notification back to the student when it is ready for pick up. It would also display a count of parts with high demand; therefore the student can see from the app its availability. We are also going to implement a scanner, with which we are going to be able to keep track of the parts availability and to which student it was assigned and when, allowing for a better control of the parts and therefore if any damage to the equipment or failure to bring it back, the system would display the student that had it or has it still. Each of the high demand equipment will have to have a tag for this system to be implemented and to allow for the track of them individually.
	
The project will require the app to have a solid and easy to use interface in order for the user to request parts and retrieve any information required. The database will be able to provide the student with a lot of information that we feel wasn’t always given, and with that the potential of reducing equipment damage as well. We firmly believe that this project will improve the students’ performance in labs, since he will know beforehand the parts availability and will be able to request it remotely, guaranteeing that he will have it in lab. The cribs efficiency, since requests and control of which student has which equipment, will be done through the system and the equipment life, since more information about it will be given to students.
